    ...
    <section className="bg-gradient-to-br from-[#1a0b1f] via-[#2E003E] to-[#3d1448] py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="hero-title text-5xl md:text-6xl font-plus-jakarta font-bold text-white mb-6">
            Revenue Engine for{' '}
            <span className="text-[#D6C2E5] bg-gradient-to-r from-[#D6C2E5] to-white bg-clip-text text-transparent">Independent Clinics</span>
          </h1>
          
          <p className="hero-subtitle text-xl md:text-2xl text-gray-200 mb-8 font-plus-jakarta leading-relaxed">
